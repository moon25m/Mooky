...
// When to show the floating Enter button (ms after load)
export const SPLASH_ENTER_APPEAR_MS = 2000;

// Duration of the zoom-out animation on the splash title (must match CSS)
export const SPLASH_ANIMATE_MS = 3000;
